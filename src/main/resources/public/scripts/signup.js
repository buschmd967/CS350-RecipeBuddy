...
$(document).ready(function() {
    ...
    applianceTemplate = $("#appInputs").clone();
    ingTemplate = $("#ingInputs").clone(); // ROSIE just added
});
...
function addAppliance(){
    $("#appSelection").append(applianceTemplate.clone());
}


/* ROSIE JUST ADDED */
function addIngredient(){
    $("#ingSelection").append(ingTemplate.clone());
}
/*END OF ROSIE ADD*/
